...
**说明：**Pycharm是最好用的Python集成开发环境之一，属于JetBrain开发的IDEA、Pycharm、WebStorm等软件体系。
<!-- more -->
...
* Pycharm是最好用的Python集成开发环境之一，由捷克jetbrains公司开发。

### 快捷键

参考[Mac下PyCharm快捷键大全](https://blog.csdn.net/qq_18863573/article/details/74910975)
